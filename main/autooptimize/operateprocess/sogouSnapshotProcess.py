...
# Embedded file name: C:\PycharmProjects\AutoOptimize\autooptimize\operateprocess\sogouSnapshotProcess.py
...
class SogouSnapshotProcess(AbstractProcess):
    ...
    def execute(self):
        ...
        if GlobalEnvStorage.customerKeyword.terminalType == 'PC':
            SogouPCOperateTarget().initPageSize()
        if randint(1, 100) <= 40:
            disturbType = 8
            if disturbType == 1:
